...
// EXPLAIN: this code logs 0, 1, 2, because this loop is telling the program to start
// by logging 0, then add 1 to the index, then print the next number for all numbers
// less than 3.
